...
While we consider such an explanation plausible, and even likely, a conclusive confirmation requires proper forward modeling of size and color jointly. Such an effort is well motivated by our results, but is beyond the scope of the present work.
...
Our publicly available python code provides a simple means for cosmological surveys to generate synthetic galaxy populations with realistic sizes across the cosmic web. Mock catalogs of $z=0$ model galaxies with $\mstar$ and $\rhalf$ will be made publicly available upon journal publication; prior to that time, our mocks are available upon request.
