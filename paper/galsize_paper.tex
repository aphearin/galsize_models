...
\begin{abstract}
Using new measurements of projected two-point correlation function, $\wproj(\rproj)$, of  the Sloan Digital Sky Survey galaxies of different sizes and stellar masses,
 we place empirical constraints on the connection between galaxy size and halo virial radius.  
...
\item Taken together, our findings indicate that satellite-specific processes play a sub-dominant role in setting the different sizes of centrals and satellites; the sizes of satelitte galaxies instead appear to be largely predetermined at the time of their infall.
