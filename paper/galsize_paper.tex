...
In addition to stellar mass galaxy clustering depends on galaxy color \citep[e.g.,][]{zehavi_etal11}. Thus, we will also consider 
...
As noted in \S\ref{sec:intro}, \citet{kravtsov13} showed that galaxy sizes are on average proportional to the virial radius of their host halo. Motivated by these results, we  explore a model in which $\rhalf$ scales linearly with the halo virial radius:\footnote{We note that the normalization factor in \citet{kravtsov13} is 0.015, where as our normalization is 0.01. The difference derives from the choice of halo radius definition: \citet{bryan_norman98} in the present work, compared to the $200c$ definition used in \citet{kravtsov13} and the fact that the latter study used deprojected (larger) sizes for spheroidal galaxies. } 
\beq
