...
\begin{abstract}
Using new measurements of the projected two-point correlation function, $\wproj(\rproj)$, of  the Sloan Digital Sky Survey galaxies of different sizes and stellar masses,
