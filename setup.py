...
PACKAGENAME = metadata.get('package_name', 'galsize_models')
DESCRIPTION = metadata.get('description', 'Empirical models of galaxy size')
AUTHOR = metadata.get('author', 'Andrew Hearin')
